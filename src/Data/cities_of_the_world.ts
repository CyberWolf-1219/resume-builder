export const COUNTRIES = {
  ...
  "The Bahamas": [ "Nassau", "Freeport City", "West End" ],
  ...
  "New Caledonia": [ "Noumea", "Kone", "We", "Dumbea", "Mont-Dore", "Paita" ],
  "Kosovo": [
    "Pristina",
    "Ferizaj",
    "Gjakove",
  ...
  "Seychelles": [ "Victoria" ],
  "Saint Vincent and the Grenadines": [ "Kingstown", "Calliaqua" ],
  "Andorra": [
    "Andorra la Vella",
    "Escaldes-Engordany",
    "Encamp",
  ...
  "Cook Islands": [ "Avarua" ],
  "Grenada": [ "Saint George's", "Saint David's" ],
  "San Marino": [
    "San Marino",
    "Serravalle",
    "Borgo Maggiore",
